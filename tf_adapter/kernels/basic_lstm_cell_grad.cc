...
public:
    ...
    ~BasicLSTMCellCStateGradOp() {}
    void Compute(OpKernelContext* context) override
    {
        LOG(INFO) << "BasicLSTMCellCStateGradOp Compute ";
    }
...
public:
    ...
    ~BasicLSTMCellWeightGradOp() {}
    void Compute(OpKernelContext* context) override
    {
        LOG(INFO) << "BasicLSTMCellWeightGradOp Compute ";
    }
    bool IsExpensive() override { return false; }
};
...
public:
    ...
    ~BasicLSTMCellInputGradOp() {}
    void Compute(OpKernelContext* context) override
    {
        LOG(INFO) << "BasicLSTMCellInputGradOp Compute ";
    }
    bool IsExpensive() override { return false; }
};
