...
class GeOp : public AsyncOpKernel {
 ...
 private:
  ...
  void BuildGraphDef(OpKernelContext *ctx, DoneCallback done,
                     const FunctionLibraryDefinition &flib_def, const FunctionDef &func_def,
 ...
 private:
  ...
  // std::vector<TensorShape> inputs_shape_;
