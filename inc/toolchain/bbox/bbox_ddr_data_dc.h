 ...
 */
#ifndef BBOX_DDR_DATA_DC_H
#define BBOX_DDR_DATA_DC_H
...
#define DATA_MODEL_TS_START MODEL_VECTOR(TS_START) = { \
    {"ts start info", ELEM_OUTPUT_STR_NL, {0x0}, {0x19000}}, \
}

/* TS module */
#define DATA_MODEL_TS MODEL_VECTOR(TS) = { \
    {"ts info", ELEM_OUTPUT_STR_NL, {0x0}, {0x1E6E00}}, \
}
